...
public class ExpandableCardView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        if (!TextUtils.isEmpty(description1)) textViewDescription1.setText(description1);
        if (!TextUtils.isEmpty(description2)) textViewDescription2.setText(description2);
