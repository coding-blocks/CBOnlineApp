...
class MyCourseActivity : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.whatsappLink = intent.getStringExtra(WHATSAPP_GROUP_LINK) ?: ""
    ...
    private fun setupViewPager(crUid: String, crCourseId: String) {
        ...
        adapter.add(AnnouncementsFragment.newInstance(viewModel.courseId,viewModel.whatsappLink,viewModel.attemptId), "About")
