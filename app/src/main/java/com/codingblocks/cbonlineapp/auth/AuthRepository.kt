...
class AuthRepository(
    ...
    suspend fun verifyOtp(otp: Int, uniqueId: String) = safeApiCall {
        CBOnlineLib.api.verifyOtp(uniqueId, hashMapOf("otp" to otp, "client" to "android"))
    }
    ...
    suspend fun verifyMobileUsingClaim(uniqueId: String) = safeApiCall {
        CBOnlineLib.api.verifyMobile(hashMapOf("claimId" to uniqueId))
    }
