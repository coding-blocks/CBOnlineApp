...
//    }
    ...
    @Test
    fun `GET myCourse`() {
        val attempt = api.enrolledCourseById("JWT eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..gaNN76vYPViHImftBN5rg9WaaLgWpCBXOeSiL4axlwHz_Yi-VqJnXQbPe-vDt93Rax_uQYpcSuzzpXmqQy0c3IIuHfiJvMu6BDryAHgHmMXMENo04fQh2h7Tq8b7nUPQuNp9NfhxMTMX5sne8JjGTBcsYjOzCsSWzYigUE6dDQjRmL7sjcxUi0BstoMskey_SMeqFEQQs-wAh9B2Fip7wG96J6bosi5s1fQ11kP9oQRtQWMqeQ6C0ITT99DE2OUHzgU5soE4WFyeEI_9-t2zDE9BhsNwB2dTUh6renIaqBh3jgArAljJggB8tOQ2eEMOMJElp8DD1xFNcbsegN8n5g","8252").execute().body()
        attempt?.let {
            assertEquals(1,1)
        }
    }
